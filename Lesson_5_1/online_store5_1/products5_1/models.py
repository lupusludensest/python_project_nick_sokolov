...
# 1
class Contact(models.Model): # Starts from the capital letter and always singular
    class Meta:
...
class Supplier(models.Model):
    ...
    contact = models.ForeignKey(Contact, blank=False, null=False, verbose_name='Contact ID', on_delete=models.CASCADE)
...
class Client(models.Model):
    ...
    contact = models.ForeignKey(Contact, blank=False, null=False, default="", editable=False, verbose_name='Contact ID', on_delete=models.CASCADE)
...
class Product(models.Model):
    ...
    supplier = models.ForeignKey(Supplier, blank=False, null=False, default="", editable=False, verbose_name='Supplier ID', on_delete=models.CASCADE)
    ...
    quantity_per_unit = models.IntegerField(blank=False, null=False, default=0, editable=True, verbose_name='Quantity per unit')
    unit_price = models.FloatField(blank=False, null=False, default=0, editable=False, verbose_name='Unit price')
    ...
    weight = models.FloatField(blank=False, null=False, max_length=7, default=0, editable=True, verbose_name='Weight of the product in KGs')
...
class Category(models.Model):
    ...
    category = models.CharField(blank=False, null=False, default="", max_length=30, editable=False, verbose_name='Category')
    description = models.TextField(blank=False, null=False, default="", max_length=999, editable=True, verbose_name='Description')
...
class ProductCategory(models.Model):
    ...
    product = models.ForeignKey(Product, blank=False, null=False, default="", editable=False, verbose_name='Product ID', on_delete=models.CASCADE)
    category = models.ForeignKey(Category, blank=False, null=False, default="", editable=False, verbose_name='Category ID', on_delete=models.CASCADE)
...
class Rating(models.Model):
    ...
    client = models.ForeignKey(Client, blank=False, null=False, default="", editable=False, verbose_name='Client ID', on_delete=models.CASCADE)
    product = models.ForeignKey(Product, blank=False, null=False, default="", editable=False, verbose_name='Product ID', on_delete=models.CASCADE)
    date_posted = models.DateField(blank=False, null=False, default="", editable=False, verbose_name='Date posted')
    rating = models.FloatField(blank=False, null=False, max_length=2,  default=0, editable=True, verbose_name='Rating')
...
class Order(models.Model):
    ...
    client = models.ForeignKey(Client, blank=False, null=False, default="", editable=False, verbose_name='Client ID', on_delete=models.CASCADE)
    shipper = models.ForeignKey(Shipper, blank=False, null=False, default="", editable=False, verbose_name='Shipper ID', on_delete=models.CASCADE)
    ...
    total_price = models.FloatField(blank=False, null=False, default=0, editable=False, verbose_name='Total price')
    sale_tax = models.FloatField(blank=False, null=False, default=0, editable=False, verbose_name='Sale tax')
    discount = models.FloatField(blank=False, null=False, default=0, editable=True, verbose_name='Discount')
    total_discount = models.FloatField(blank=False, null=False, default=0, editable=True, verbose_name='Total discount')
    paid = models.FloatField(blank=False, null=False, default=0, editable=False, verbose_name='Paid')
...
class Cart(models.Model):
    ...
    order = models.ForeignKey(Order, blank=False, null=False, default="", editable=False, verbose_name='Order ID', on_delete=models.CASCADE)
    product = models.ForeignKey(Product, blank=False, null=False,  default="", editable=False, verbose_name='Product ID', on_delete=models.CASCADE)
    ...
    sale_tax = models.FloatField(blank=False, null=False,  default=0, editable=True, verbose_name='Sale tax')
    discount = models.FloatField(blank=False, null=False, default=0, editable=True, verbose_name='Discount')
    total_discount = models.FloatField(blank=False, null=False,  default=0, editable=True, verbose_name='Total discount')
