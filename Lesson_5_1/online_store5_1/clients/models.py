...
class Client(models.Model): # Starts from the capital letter and always singular
    class Meta:
        db_table = 'clients' # Starts from the lowercase letter and can be plural
        verbose_name = 'Client' # Starts from the capital letter and always singular
        verbose_name_plural = 'Clients' # Starts from the capital letter and always plural
